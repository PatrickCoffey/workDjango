"""
Starter fabfile for deploying the workDjango project.
...
# CHANGEME
env.hosts = ['user@workDjango.example.com']
env.code_dir = '/srv/www/workDjango'
env.project_dir = '/srv/www/workDjango/workDjango'
env.static_root = '/srv/www/workDjango/static/'
env.virtualenv = '/srv/www/workDjango/.virtualenv'
env.code_repo = 'git@github.com:user/workDjango.git'
env.django_settings_module = 'workDjango.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/workDjango/wsgi.py" % env.code_dir)
